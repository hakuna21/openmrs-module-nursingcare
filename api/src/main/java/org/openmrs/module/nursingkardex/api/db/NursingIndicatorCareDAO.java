...
public interface NursingIndicatorCareDAO {
	...
	Integer getBedCapacity(Integer locationId, Date startDate, Date endDate);
	
	Integer getTotalLast(Integer locationId, Date startDate, Date endDate);
	
	Integer getDailyOccupancyRate(Integer locationId, Date startDate, Date endDate);
